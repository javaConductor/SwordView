...
// https://www.youtube.com/watch?v=szmS_M-BMls&list=PL6gx4Cwl9DGBuKtLgPR_zWYnrwv-JllpA&index=5#t=273.456242
 ...
 class LessonElement extends React.Component {
    ...
    getInitialState() {
    console.debug("lesson-element: initialState: props", this.props);
        return {
...
// />
 class LessonEditor extends React.Component {
    ...
    getInitialState() {
        console.debug( "lesson-editor.getInitialState: props: ", this.props );
        
        let lesson = Object.assign({}, this.props.lesson);
        lesson.elements = lesson.elements || [];
        let state = {
            lesson: lesson
        };
        console.debug( "lesson-editor.getInitialState: state: ", state );
        return state;
    }
